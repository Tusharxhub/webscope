        ...
        <Card className="p-5 mb-6">
          <div className="flex gap-3">
            <input
              ...
              disabled={loading}
              className="flex-1 px-3 py-2 rounded-md bg-zinc-50 dark:bg-zinc-800/80 border border-zinc-200 dark:border-zinc-700 text-zinc-900 dark:text-zinc-100 placeholder-zinc-400 dark:placeholder-zinc-600 text-sm font-mono focus:outline-none focus:ring-2 focus:ring-indigo-500/30 focus:border-indigo-500 transition-colors duration-150 disabled:opacity-40"
            />
            <Button onClick={handleScrape} loading={loading} size="md">
